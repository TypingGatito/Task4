...
public class VectorDimFourTest {
    ...
    void sumVector(){
        ...
        assertEquals(0.0f, v3.getV()[0]);
        assertEquals(0.0f, v3.getV()[1]);
        assertEquals(3.8f, v3.getV()[2]);
        assertEquals(6.0f, v3.getV()[3]);
    }
    ...
    void subtractVector(){
        ...
        assertEquals(-48.0f, v3.getV()[0]);
        assertEquals(46.0f, v3.getV()[1]);
        assertEquals(-1.3f, v3.getV()[2]);
        assertEquals(7.7f, v3.getV()[3]);
    }
    ...
    void multiplyByScalar(){
        ...
        assertEquals(240.0f, v3.getV()[0]);
        assertEquals(-230.0f, v3.getV()[1]);
        assertEquals(-10.0f, v3.getV()[2]);
        assertEquals(77f, v3.getV()[3]);
    }
    ...
    void divideByScalar(){
        ...
        assertEquals((float) -4.5, v3.getV()[2]);
        assertEquals(-2.3f, v3.getV()[3]);
    }

    @Test
    void getVectorLength(){
        VectorDimFour v1 = new VectorDimFour(new float[]{-6, 8, 0, 0});
        assertEquals((float) 10.0, VectorDimFour.getVectorLength(v1));
    }
    ...
    void normalize(){
        ...
        assertEquals((float) 0.0, v3.getV()[2]);
        assertEquals(0.0f, v3.getV()[3]);
    }
    ...
    void normalizeByW(){
        ...
        assertEquals((float) -6, v2.getV()[0]);
        assertEquals(3.5f, v2.getV()[1]);
        assertEquals(2.3f, v2.getV()[2]);
    }
}
