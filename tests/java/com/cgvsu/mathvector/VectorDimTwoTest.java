...
public class VectorDimTwoTest {
    ...
    void sumVector(){
        ...
        Assertions.assertEquals((float) 0.0, v3.getV()[0]);
        Assertions.assertEquals((float) 0.0, v3.getV()[1]);
    }
    ...
    void subtractVector(){
        ...
        Assertions.assertEquals((float) -48.0, v3.getV()[0]);
        Assertions.assertEquals((float) 46.0, v3.getV()[1]);
    }
    ...
    void multiplyByScalar(){
        ...
        Assertions.assertEquals((float) 240.0, v3.getV()[0]);
        Assertions.assertEquals((float) -230.0, v3.getV()[1]);
    }
    ...
    void getVectorLength(){
        ...
        Assertions.assertEquals((float) 10.0, VectorDimTwo.getVectorLength(v1));
    }
    ...
    void scaleMultiply(){
        ...
        Assertions.assertEquals(29.0f, res);
    }
}
