...
public class VectorDimThreeTest {
    ...
    void getVectorLength(){
        ...
        assertEquals((float) 10.0, VectorDimThree.getVectorLength(v1));
    }
    ...
    void vectorMultiplyV3(){
        ...
        assertEquals((float) -7.0, v3.getV()[0]);
        assertEquals((float) 8.0, v3.getV()[1]);
        assertEquals((float) -3.0, v3.getV()[2]);
    }
}
